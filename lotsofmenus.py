...
session.add_all([menu_item_1, menu_item_2, menu_item_3, menu_item_4, menu_item_5])
session.commit()
...
session.add_all([menu_item_1, menu_item_2])
session.commit()
...
session.add_all([menu_item_1, menu_item_2, menu_item_3])
session.commit()
